...
__webpack_require__(/*! ./scripts/custom.js */ "./resources/js/scripts/custom.js");

window.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
window.axios.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest'; // var Turbolinks = require("turbolinks")
// Turbolinks.start()
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function init_template() {
    ...
    checkedCard.forEach(function (el) {
      return el.addEventListener('click', function (e) {
    ...
    function activateMenus() {
      var menuActive = document.querySelectorAll('[data-menu-active]')[0];
    ...
    function card_extender() {
      ...
      for (var _i12 = 0; _i12 < cards.length; _i12++) {
        ...
        if (cards[_i12].getAttribute('data-card-height') === "cover-card") {
          var windowHeight = window.outerHeight;
          var coverHeight = windowHeight - 300 + 'px';
          cards[_i12].style.height = coverHeight;
        }

        if (cards[_i12].getAttribute('data-card-height') === "cover-full") {
          if (window.matchMedia('(display-mode: fullscreen)').matches) {
            var windowHeight = window.outerHeight;
          }
    ...
    if (checkVisited.length) {
      var check_visited_links = function check_visited_links() {
        ...
        for (var _i13 = 0; _i13 < links.length; _i13++) {
          var that = links[_i13];
    ...
    dataMenuLoad.forEach(function (e) {
      ...
      fetch(menuLoad).then(function (data) {
        return data.text();
      }).then(function (html) {
        ...
        setTimeout(function () {
          if (dataMenuLoad[dataMenuLoad.length - 1] === e) {
            menuFunction(); // checkDarkMode();

            activateMenus(); // shareLinks();
            // highlightColors();
            // selectHighlight();
            // card_extender();
            // backUp();
    ...
    if (!isMobile.any()) {
      for (var _i14 = 0; _i14 < iOSDev.length; _i14++) {
        iOSDev[_i14].classList.add('disabled');
      }

      for (var _i15 = 0; _i15 < androidDev.length; _i15++) {
        androidDev[_i15].classList.add('disabled');
      }
    }
    ...
    if (isMobile.iOS()) {
      ...
      for (var _i16 = 0; _i16 < noDev.length; _i16++) {
        noDev[_i16].classList.add('disabled');
      }

      for (var _i17 = 0; _i17 < androidDev.length; _i17++) {
        androidDev[_i17].classList.add('disabled');
      }
    }
    ...
    if (isMobile.Android()) {
      ...
      for (var _i18 = 0; _i18 < iOSDev.length; _i18++) {
        iOSDev[_i18].classList.add('disabled');
      }

      for (var _i19 = 0; _i19 < noDev.length; _i19++) {
        noDev[_i19].classList.add('disabled');
      }

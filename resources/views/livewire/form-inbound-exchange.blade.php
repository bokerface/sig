<div>
    <x-modal-title title="Inbound Exchange" bg="bg-sigov-red" />
    ...
    <form class="p-4 pt-2 formsd" wire:submit.prevent="handleForm" enctype="multipart/form-data">
        ...
        <div class="mb-2">
            <label for="inputfile" class="form-label @error('curriculum_vitae') text-danger @enderror">Curriculum Vitae
        ...
        <div class="mb-2">
            <label for="inputfile" class="form-label @error('motivation_letter') text-danger @enderror">Motivation
                Letter <span class="text-danger">*</span></label>

            <input type="file" wire:model="motivation_letter"
        ...
        <div class="mb-2">
            <label for="inputfile" class="form-label @error('passport') text-danger @enderror">Scanned Copy of Passport
                <span class="text-danger">*</span></label>
        ...
        <div class="mb-2">
            <label for="inputfile" class="form-label @error('certificate') text-danger @enderror">Scanned Copy of
                English Proficiency Certificate <span class="text-danger">*</span></label>
        ...
        <div class="mb-3">
            <label for="inputfile" class="form-label @error('photo') text-danger @enderror">Latest Photograph <span

    ...
    <body class="body-sd theme-light" data-highlight="pink">
        ...
        <div id="page" class="bg-white">
            ...
            <div id="menu-login" class="menu menu-box-right" data-menu-height="cover" data-menu-width="cover"
            ...
            <div id="menu-install-pwa-ios" class="menu menu-box-bottom menu-box-detached rounded-l"
                ...
                <div class="boxed-text-xl mt-4">
                    ...
                    <h4 class="mt-3">SIGOV on your Home Screen</h4>
                    <p class="mb-0 pb-3">
                        Install SIGOV on your home screen, and access it just like a regular app. Open your Safari menu

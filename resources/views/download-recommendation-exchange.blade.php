...
<p class="justify">Maka untuk itu, kami menyampaikan permohonan Surat Keputusan (SK) program Student Exchange untuk
    mahasiswa dibawah ini: </p>
...
<table class="table table-bordered" style="width:16cm; margin-left:30px;">
    ...
    <tr>
        ...
        {{-- <td style="text-align: center">{{ institution_name($meta[0]->value) }}
        {{ destination_name($meta[1]->value) }} \\ </td> --}}
    </tr>
</table>
...
<p class="justify">Demikian surat pemberitahuan ini kami buat. Atas perhatian dan kerjasama Bapak/Ibu kami ucapkan
    terima
    kasih.</p>
